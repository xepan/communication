...
class Initiator extends \Controller_Addon {
	...
	function init(){
		...
		if($this->app->is_admin){
			$this->app->side_menu->addItem(['Emails','icon'=>' fa fa-users','badge'=>[$contact_count. " / " .$all_count ,'swatch'=>' label label-primary label-circle pull-right']],'xepan_communication_emails');
		}
